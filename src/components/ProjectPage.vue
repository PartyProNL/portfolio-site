  ...
  <div class="w-full px-20 h-screen max-h-screen overflow-hidden bg-black text-white">
    <div class="flex justify-between font-[Didot]">
      <div class="flex mt-auto items-center">
        ...
        <h2 class="font-thin tracking-tight text-3xl ml-2" style="font-stretch: 1000%">Back</h2>
      </div>
      <h1 class="font-thin text-8xl leading-[0.8] mt-6">{{ project.name.toUpperCase() }}</h1>
    </div>

    <div class="min-w-full h-[520px]">
      <div class="banner w-full h-[520px] bg-cover bg-center absolute left-0" :style="{backgroundImage: 'url('+project.image+')'}">
